    ...
    responses: [
        {
            ...
            answer: mongoose_1.Schema.Types.Mixed, // Flexible for different response types
        },
    ],
    userId: { type: String },
}, { timestamps: true });
const FormResponse = mongoose_1.default.models.Response ||
    (0, mongoose_1.model)("Response", ResponseSchema);
